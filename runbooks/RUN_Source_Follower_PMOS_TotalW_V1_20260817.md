# Run - PMOS Source Follower TotalW V1

## Generator

```text
canonical/amplifier/SourceFollower_PMOS_TotalW_V1_20260817.il
```
...
```cmd
scp "C:\Users\<user>\Desktop\SourceFollower_PMOS_TotalW_V1_20260817.il" cadence@192.168.75.217:/home/cadence/
```

## Load in CIW

```skill
load("/home/cadence/SourceFollower_PMOS_TotalW_V1_20260817.il")
```

## Run

```skill
CreateSourceFollower_PMOS_TotalW_V1_20260817()
```
...
```text
pmos-source-follower  (circuit: amplifier)
```
...
```textV_VIN = 0.75 V   V_VBP = 0.75 V   V_VDD = 1.50 V   V_VSS = 0.00 V
```
...
```text
ADS_BRIDGE_START
PSF: <device> TotalW=... W/finger=... L=... NF=... M=... totalM=...
PSF: STUB <device>.<terminal> -> <net>
PSF GENERATOR COMPLETED
...
Simulation-ready via the ac-amplifier profile (buffer: GBW reported as not applicable when sub-unity).
