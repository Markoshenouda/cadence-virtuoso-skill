# Run - PMOS-Input Cascode Amplifier TotalW V1

## Generator

```text
canonical/amplifier/CascodeAmp_PMOS_TotalW_V1_20260817.il
```
...
```cmd
scp "C:\Users\<user>\Desktop\CascodeAmp_PMOS_TotalW_V1_20260817.il" cadence@192.168.75.217:/home/cadence/
```

## Load in CIW

```skill
load("/home/cadence/CascodeAmp_PMOS_TotalW_V1_20260817.il")
```

## Run

```skill
CreateCascodeAmp_PMOS_TotalW_V1_20260817()
```
...
```text
cascode-amplifier-pmos  (circuit: amplifier)
```
...
```textV_VIN = 1.25 V   V_VBP_CAS = 1.55 V   V_VBN = 0.60 V   V_VDD = 2.00 V   V_VSS = 0.00 V
```
...
```text
ADS_BRIDGE_START
PCA: <device> TotalW=... W/finger=... L=... NF=... M=... totalM=...
PCA: STUB <device>.<terminal> -> <net>
PCA GENERATOR COMPLETED
