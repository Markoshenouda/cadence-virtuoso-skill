# Run - Complementary Source Follower TotalW V1

## Generator

```text
canonical/amplifier/SourceFollower_Complementary_TotalW_V1_20260817.il
```
...
```cmd
scp "C:\Users\<user>\Desktop\SourceFollower_Complementary_TotalW_V1_20260817.il" cadence@192.168.75.217:/home/cadence/
```

## Load in CIW

```skill
load("/home/cadence/SourceFollower_Complementary_TotalW_V1_20260817.il")
```

## Run

```skill
CreateSourceFollower_Complementary_TotalW_V1_20260817()
```
...
```text
complementary-source-follower  (circuit: amplifier)
```
...
```textV_VIN = 0.75 V (shared gate)   V_VDD = 1.50 V   V_VSS = 0.00 V
```
...
```text
ADS_BRIDGE_START
CSB: <device> TotalW=... W/finger=... L=... NF=... M=... totalM=...
CSB: STUB <device>.<terminal> -> <net>
CSB GENERATOR COMPLETED
...
Simulation-ready via the ac-amplifier profile (class-AB buffer; DC bias at the inverter trip point).
