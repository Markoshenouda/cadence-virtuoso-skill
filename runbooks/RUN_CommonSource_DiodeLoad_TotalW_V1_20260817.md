# Run - Common-Source with Diode Load TotalW V1

## Generator

```text
canonical/amplifier/CommonSource_DiodeLoad_TotalW_V1_20260817.il
```
...
```cmd
scp "C:\Users\<user>\Desktop\CommonSource_DiodeLoad_TotalW_V1_20260817.il" cadence@192.168.75.217:/home/cadence/
```

## Load in CIW

```skill
load("/home/cadence/CommonSource_DiodeLoad_TotalW_V1_20260817.il")
```

## Run

```skill
CreateCommonSource_DiodeLoad_TotalW_V1_20260817()
```
...
```text
common-source-diode-load  (circuit: amplifier)
```
...
```textV_VIN = 0.75 V   V_VDD = 1.50 V   V_VSS = 0.00 V
```
...
```text
ADS_BRIDGE_START
CDL: <device> TotalW=... W/finger=... L=... NF=... M=... totalM=...
CDL: STUB <device>.<terminal> -> <net>
CDL GENERATOR COMPLETED
...
Simulation-ready via the ac-amplifier profile (self-biasing diode load).
