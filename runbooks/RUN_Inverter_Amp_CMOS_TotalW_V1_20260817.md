# Run - CMOS Inverter Amplifier TotalW V1

## Generator

```text
canonical/amplifier/Inverter_Amplifier_CMOS_TotalW_V1_20260817.il
```
...
```cmd
scp "C:\Users\<user>\Desktop\Inverter_Amplifier_CMOS_TotalW_V1_20260817.il" cadence@192.168.75.217:/home/cadence/
```

## Load in CIW

```skill
load("/home/cadence/Inverter_Amplifier_CMOS_TotalW_V1_20260817.il")
```

## Run

```skill
CreateInverter_Amplifier_CMOS_TotalW_V1_20260817()
```
...
```text
cmos-inverter-amplifier  (circuit: amplifier)
```
...
```textV_VIN = 0.75 V (self-bias trip region)   V_VDD = 1.50 V   V_VSS = 0.00 V
```
...
```text
ADS_BRIDGE_START
CIA: <device> TotalW=... W/finger=... L=... NF=... M=... totalM=...
CIA: STUB <device>.<terminal> -> <net>
CIA GENERATOR COMPLETED
...
Simulation-ready via the ac-amplifier profile (bias at the inverter trip point).
