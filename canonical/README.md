...
| Topology expansion batch (2026-08-17) | `current-mirror/` (Wilson, regulated-cascode, cascode-PMOS, dual-output, complementary, wide-swing, cascode NMOS/PMOS current sources, cascode bias stack), `differential-pair/` (PMOS pair, PMOS-load, folded, cascode-tail), `amplifier/` (diode-load CS, PMOS cascode, folded cascode NMOS/PMOS, common-gate NMOS/PMOS, class-AB stage, super/PMOS/complementary followers, inverter amplifier, common-gate TIA), `ota/` (two-stage Miller, current-mirror, symmetrical, three-stage, fully-differential folded), `comparator/` (CMOS, two-stage, StrongARM), `gm-c/` (gm-C integrator) | 35 new TotalW-first schematic candidates following the house generator pattern; none electrically verified; see each runbook for SIMULATION_READY / SCHEMATIC_ONLY status |
